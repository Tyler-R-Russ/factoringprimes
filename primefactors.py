import sys
sys.path.append('/Users/tyler/OneDrive/Desktop/Software/Python/PortablePython2.7.5.1/numbertheory')
#sys.path.append('numbertheory')
import totient
...
def primefactors(n):
    ...
    i=1
    for i in lst:
        lst = filter (lambda i:totient(i)==i-1,lst)
